...
if (window.innerWidth > 600) {
    ...
    gsap.fromTo('.header_left-logoImg', { opacity: 0, x: -20 }, { delay: 1, opacity: 1, x: 0, rotation: 180 })
    ...
    gsap.fromTo(".header_right-linkedIn", { scaleX: 1.7, scaleY: 1.7, x: 300 }, { duration: 1, x: 0, scaleX: 1.7, scaleY: 1.7 })
    gsap.fromTo('.header_right-github', { scaleX: 1.7, scaleY: 1.7 }, { scaleX: 1.7, scaleY: 1.7 })
    gsap.fromTo('.header_right-contact ', { scaleX: 1.7, scaleY: 1.7 }, { scaleX: 1.7, scaleY: 1.7 })
